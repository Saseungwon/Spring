	...
	<div class="container">
		...
		<form:form action="freeModify.wow" method="post" modelAttribute="free">
			<table class="table table-striped table-bordered">
				...
				<tr>
					<th>글번호</th>
					<td>${free.boNo}<form:hidden path="boNo"/></td>
				</tr>
				<tr>
					<th>제목</th>
				...
				<tr>
					<th>작성자</th>
					<td>${free.boWriter }<form:hidden path="boWriter"/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><form:password path="boPass" cssClass="form-control input-sm" required="required" /><span class="text-danger"> <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> 글 등록시에 입력한 비밀번호를 입력하세요.
						</span>
